...
<template>
    <main class="page">
        ...
        <section>
            ...
            <div>
                <iframe height="600" style="width: 100%;" scrolling="no" title="Calculator" src="https://codepen.io/brittrohrer/embed/QwLmRVd?default-tab=html%2Cresult&theme-id=dark" frameborder="no" loading="lazy" allowtransparency="true" allowfullscreen="true">
